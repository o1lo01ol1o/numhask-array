...
module NumHask.Array.Example where
...
-- | Array creation
-- fixed size arrays always need full type specification
--
-- >>> [1.2, 3.5, 5.1] :: Array '[4] Double
-- [1.2, 3.5, 5.1, 0.0]
--
-- lists of lists is not a thing
-- >>> import GHC.Exts (fromList)
...
--
-- complex numbers
-- >>> fromList (P.zipWith (\r i -> (fromIntegral r) :+ (fromIntegral i)) [1..] [0..]) :: Array '[2,3] (Complex Double)
...
-- | creating series
-- >>> :set -XTypeFamilies
-- >>>  [10,15 .. 30] :: Array '[5] Int
-- [10, 15, 20, 25, 30]
--
-- >>> [0, 0.3.. 2] :: Array '[8] Double
-- [0.0, 0.3, 0.6, 0.8999999999999999, 1.1999999999999997, 1.4999999999999996, 1.7999999999999994, 2.099999999999999]
--
...
-- 9
--
-- todo: folding and scanning by dimension
--
-- | universals
...
--
-- | slicing
-- todo: integrate slice technology
